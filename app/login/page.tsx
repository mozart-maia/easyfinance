...
export default function LoginPage() {
  ...
  const [imageList, setImageList] = useState<ReactElement[]>([
    <Image
      ...
      alt="Empty glasses. Image of Jocke Wulcan in Unsplash"
    />,
    <Image
      className="h-full w-full object-cover"
      key={2}
      width={500}
      height={500}
      src="/john-mcarthur-ROQzKIAdY78-unsplash.jpg"
      alt="Empty glasses. Image of Jocke Wulcan in Unsplash"
    />,
    <Image
      className="h-full w-full object-cover"
      ...
      width={500}
      height={500}
      src="/kelvin-zyteng-LMq-rTluKfQ-unsplash.jpg"
      alt="Empty glasses. Image of Jocke Wulcan in Unsplash"
    />,
    <Image
      className="h-full w-full object-cover"
      ...
      width={500}
      height={500}
      src="/optical-chemist-uz7dXgkdvkU-unsplash.jpg"
      alt="Empty glasses. Image of Jocke Wulcan in Unsplash"
    />,
  ]);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
          ...
          <div className="max-w-md space-y-8 px-4 py-12 sm:px-6 lg:px-8">
            <div className="space-y-5">
              ...
              <p className="text-sm text-gray-500">
                Faça login para acessar suas ferramentas de controle financeiro e manter
        ...
        {/* Left side - Image */}
        <div className="hidden w-1/2 bg-gray-100 lg:block">{image}</div>
      </div>
    </div>
  );
}
